...
{
  echo "[+] Creating files..."
    sudo cp gdb-peda /usr/local/bin/gdb-peda &&\
    sudo cp gdb-peda-arm /usr/local/bin/gdb-peda-arm &&\
    sudo cp gdb-peda-intel /usr/local/bin/gdb-peda-intel &&\
    sudo cp gdb-pwndbg /usr/local/bin/gdb-pwndbg &&\
    sudo cp gdb-gef /usr/local/bin/gdb-gef
} || {
